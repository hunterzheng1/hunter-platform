...
- [`herdr-public-adapter-gate.md`](herdr-public-adapter-gate.md) — terminal Herdr Task 1 `BLOCKED` closeout, three preserved attempts, exact-worktree hard gate, zero Agent/send/paid usage, and Tasks 2–8 `NOT_RUN`.
