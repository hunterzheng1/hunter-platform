...
- [0007 — Herdr replacement control-plane gate](0007-herdr-replacement-control-plane-gate.md) — completed with a planned Task 1 Stop
- [0008 — Archive Hunter Platform](0008-archive-hunter-platform.md) — current repository-state decision
...
history and selected Herdr only for a bounded replacement gate. That gate also
stopped at Task 1. ADR-0008 archives the project without turning any historical
result into PASS; real Provider adoption and release remain unproven.
