...
| [06 — Runtime providers and connectors](06-runtime-provider-and-connectors.md) | Herdr replacement public Adapter boundary, replaceability, and tiered capabilities |
